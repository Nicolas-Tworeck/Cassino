document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkInputValue() {
        ...
        if (inputElement.value.trim() === "" || inputElement.value.trim() === "R$") {
            ...
            warningMessage.textContent = "Enter the amount you wish to deposit";
            warningMessage.style.visibility = "visible";
        } else if (parseInt(value) < 100) {
            okButton.disabled = true;
            warningMessage.textContent = "The minimum deposit amount is R$100";
            warningMessage.style.visibility = "visible";
        } else if (parseInt(value) > 20000) {
            okButton.disabled = true;
            warningMessage.textContent = "The maximum deposit amount is R$20.000";
            warningMessage.style.visibility = "visible";
        } else {
