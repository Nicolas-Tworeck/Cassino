document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkInputValue() {
        ...
        if (inputElement.value.trim() === "" || inputElement.value.trim() === "R$") {
            ...
            warningMessage.textContent = "Enter the amount you wish to withdraw"; // Exibe o aviso
            warningMessage.style.visibility = "visible"; // Torna o aviso visível
        }
        // Se o valor for menor que 100 ou maior que 20000
        else if (parseInt(value) < 100) {
            okButton.disabled = true; // Desabilita o botão OK
            warningMessage.textContent = "The minimum withdraw amount is R$100"; // Exibe o aviso de valor mínimo
            warningMessage.style.visibility = "visible"; // Torna o aviso visível
        } else if (parseInt(value) > 10000) {
            okButton.disabled = true; // Desabilita o botão OK
            warningMessage.textContent = "The maximum withdraw amount is R$10.000"; // Exibe o aviso de valor máximo
            warningMessage.style.visibility = "visible"; // Torna o aviso visível
        }
